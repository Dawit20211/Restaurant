      ...
      <div className="flex items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <ul className="flex space-x-4">
          <li>
            <Link
              to="/foodcart"
              className="flex items-center mt-4 mr-8 font-thin text-white transition duration-300 hover:bg-orange-500"
            >
              <svg
          ...
          <li>
            <Link
              to="/about"
              className="flex items-center mt-4 mr-4 font-thin text-white transition duration-300 hover:bg-orange-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          {userDetails ? (
            ...
            <li>
              <Link
                to="/login"
                className="flex items-center mt-4 ml-3 font-thin text-white transition duration-300 hover:bg-orange-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
